...
export default function OrderManagement() {
  ...
  return (
    <div
      className={`w-full min-h-screen bg-white ${isModalOpen ? "overflow-hidden" : ""}`}
    >
      {/* REJECT MODAL */}
      {isModalOpen && (
      ...
      {/* ================= ATTRATIVE HEADER ================= */}
      <div className="relative w-full bg-[#0B1E3A] px-4 pt-6 pb-8 rounded-b-[3rem] shadow-2xl overflow-hidden mb-8 mt-8  ">
      ...
      <div className="flex flex-wrap gap-2 px-3 sm:px-6 mt-10">
        {[
          "All orders",
          "New Orders",
          "Pending Orders",
          ...
          orders.map((order) => (
            ...
            >
              ...
              {order.items?.map((item, idx) => (
                <div
                  key={idx}
                  className="flex flex-col sm:flex-row gap-4 mt-4 w-full border-t pt-4 first:border-t-0 first:pt-0"
                >
                  <img
                    src={item.image}
                    alt=""
                  ...
                  <div className="sm:ml-auto flex flex-col gap-3 sm:items-end">
                    <span className="bg-green-500 text-white px-4 py-1 rounded-md font-semibold text-sm">
                      ₹{order.total_amount}
                    </span>
