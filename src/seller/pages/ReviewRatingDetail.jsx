  ...
  <div className="bg-white border border-gray-100 rounded-2xl p-4 mb-4 shadow-sm">
    <div className="flex justify-between items-start">
      ...
      <span className="text-[10px] font-bold text-gray-400">
        {review.commented_at
          ? new Date(review.commented_at).toLocaleDateString("en-GB", {
              day: "numeric",
              month: "short",
              year: "numeric",
            })
...
export default function ReviewRatingDetail() {
    ...
    return (
      <div className="p-10 text-center">
        ...
        <button
          ...
          className="mt-4 text-purple-600 text-sm font-bold underline"
        >
          Retry
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] w-full relative pb-20">
      {" "}
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-xs font-bold bg-green-50 text-green-700 px-2 py-0.5 rounded-lg">
                {data?.discount} OFF
              </span>
            </div>
      ...
      {/* Reviews List */}
      <div className="px-4">
        <h2 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-4 ml-1">
          Customer Reviews
        </h2>
